...
const Gravity = forwardRef<GravityRef, GravityProps>(
  (
    ...
    const createRectangleBody = (
      ...
      const angle = (props.angle || 0) * (Math.PI / 180);
      const matterBodyOptions = { ...props.matterBodyOptions };
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        switch (props.bodyType) {
          case "circle":
            body = createCircleBody(x, y, width, height, props);
            break;
          case "svg":
            body = createSvgBody(x, y, element, props);
            break;
          default:
            body = createRectangleBody(x, y, width, height, props);
            break;
        }
