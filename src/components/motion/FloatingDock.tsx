...
export function Magnetic({
  ...
  useEffect(() => {
    /**
     * Calculates the distance between the mouse pointer and the center of the element,
     * and applies a magnetic effect if the distance is within a specified range.
     *
     * @param {MouseEvent} e - The mouse event containing the current pointer position.
     */
