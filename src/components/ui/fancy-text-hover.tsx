...
const INLINE_BLOCK_CLASS = "inline-block";
const POWER_EASE = "power3.inOut";
    ...
    () => {
      ...
      fancyEls.forEach((anchor) => {
        ...
        text.split("").forEach((char, i) => {
          ...
          outer.className = INLINE_BLOCK_CLASS;
          gsap.set(outer, {
            transition: "transform 0.3s cubic-bezier(0.76, 0, 0.24, 1)",
          });

          const inner = document.createElement("span");
          inner.className = INLINE_BLOCK_CLASS;

          const letter = document.createElement("span");
          letter.className = INLINE_BLOCK_CLASS;
          ...
          const onEnter = () => {
            ...
            gsap.to(inner, {
              keyframes: [
                ...
                { yPercent: -3, duration: 2.5, ease: POWER_EASE },
                { yPercent: 0, duration: 2.5, ease: POWER_EASE },
              ],
              repeat: -1,
              delay: randomDelay,
            });
